...
Hard technique for evaluating whether documentation sections have substantive content. Refer to @.opencode/dockit/references/sections.md for the full list of sections and their requirements.
...
- Guiding questions from @.opencode/dockit/references/sections.md are answered
