...
Every document in the design system follows a section structure determined by its category — either **construct** or **concept** (see @.opencode/dockit/references/documentation-types.md for the full taxonomy). This file defines the sections available for each category.
...
- Tier (Global, Sites, Apps, Pro, or Stores — see @.opencode/dockit/references/tiers.md)
