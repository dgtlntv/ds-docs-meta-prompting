...
All questions should follow the voice defined in @.opencode/dockit/references/style-guide.md — approachable, precise, and authoritative without being arrogant.
...
- The user has addressed the guiding questions for that section (see @.opencode/dockit/references/sections.md)
