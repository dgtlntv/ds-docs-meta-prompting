...
Every document in the design system follows a section structure determined by its category — either **construct** or **concept** (see @.claude/dockit/references/documentation-types.md for the full taxonomy). This file defines the sections available for each category.
...
- Tier (Global, Sites, Apps, Pro, or Stores — see @.claude/dockit/references/tiers.md)
