...
dockit ships with a built-in style guide at @.claude/dockit/references/style-guide.md. This is the source of truth for all voice evaluation — always read it before evaluating any content.
