...
- Identify the documentation type — reference @.pi/dockit/references/documentation-types.md for the available types
- Identify the tier — reference @.pi/dockit/references/tiers.md for the available tiers
...
<artifacts>
- `.planning/STATE.md` — populated with discovery answers, following @.pi/dockit/templates/state.md
</artifacts>
...
- Present the section checklist for the chosen documentation type — reference @.pi/dockit/references/sections.md
...
<artifacts>
- `.planning/docs/{doc-name}/structure.md` — following @.pi/dockit/templates/structure.md
- `.planning/docs/{doc-name}/checklist.md` — following @.pi/dockit/templates/checklist.md
- `docs/{doc-name}.md` — following @.pi/dockit/templates/document.md
</artifacts>
...
2. Ask the guiding questions for that section (from @.pi/dockit/references/sections.md)
...
1. **Voice reviewer** — checks against the style guide at @.pi/dockit/references/style-guide.md
...
<artifacts>
- `.planning/reviews/{doc-name}-review.md` — following @.pi/dockit/templates/review-report.md
</artifacts>
...
`STATE.md` tracks both the document-level status and per-section progress. See @.pi/dockit/templates/state.md for the full structure.
