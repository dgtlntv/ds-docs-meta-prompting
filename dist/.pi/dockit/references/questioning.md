...
All questions should follow the voice defined in @.pi/dockit/references/style-guide.md — approachable, precise, and authoritative without being arrogant.
...
- The user has addressed the guiding questions for that section (see @.pi/dockit/references/sections.md)
