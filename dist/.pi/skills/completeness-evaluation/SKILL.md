...
Hard technique for evaluating whether documentation sections have substantive content. Refer to @.pi/dockit/references/sections.md for the full list of sections and their requirements.
...
- Guiding questions from @.pi/dockit/references/sections.md are answered
