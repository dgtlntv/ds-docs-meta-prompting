...
3. Apply the `completeness-evaluation` skill, referencing @.agents/dockit/references/sections.md for guiding questions and minimum thresholds
4. Present findings following the output format in @.agents/dockit/references/ui-formatting.md
