...
- Identify the documentation type — reference @.agents/dockit/references/documentation-types.md for the available types
- Identify the tier — reference @.agents/dockit/references/tiers.md for the available tiers
...
<artifacts>
- `.planning/STATE.md` — populated with discovery answers, following @.agents/dockit/templates/state.md
</artifacts>
...
- Present the section checklist for the chosen documentation type — reference @.agents/dockit/references/sections.md
...
<artifacts>
- `.planning/docs/{doc-name}/structure.md` — following @.agents/dockit/templates/structure.md
- `.planning/docs/{doc-name}/checklist.md` — following @.agents/dockit/templates/checklist.md
- `docs/{doc-name}.md` — following @.agents/dockit/templates/document.md
</artifacts>
...
2. Ask the guiding questions for that section (from @.agents/dockit/references/sections.md)
...
1. **Voice reviewer** — checks against the style guide at @.agents/dockit/references/style-guide.md
...
<artifacts>
- `.planning/reviews/{doc-name}-review.md` — following @.agents/dockit/templates/review-report.md
</artifacts>
...
`STATE.md` tracks both the document-level status and per-section progress. See @.agents/dockit/templates/state.md for the full structure.
