...
Hard technique for evaluating whether documentation sections have substantive content. Refer to @.agents/dockit/references/sections.md for the full list of sections and their requirements.
...
- Guiding questions from @.agents/dockit/references/sections.md are answered
